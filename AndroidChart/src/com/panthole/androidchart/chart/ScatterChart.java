...
public class ScatterChart extends XYChart {
	...
	public void drawSeries(Canvas canvas, Paint paint, List<Float> points,
		...
		case MYPOINT:
			if (seriesIndex == 0) {
				...
				for (int i = 0; i < length; i += 2) {
					Bitmap bitmap = renderer.getPointBitmap();
					drawMyPoint(canvas, paint, bitmap, points.get(i),
							points.get(i + 1));
			}
			}
			break;
	...
	/**
	 * The graphical representation of a bitmap point shape.
	 * 
	 * @param canvas
	 *            the canvas to paint to
	 * @param paint
	 ...
	 *            the y value of the point the shape should be drawn at
	 */
	private void drawMyPoint(Canvas canvas, Paint paint, Bitmap bitmap,
			float x, float y) {
