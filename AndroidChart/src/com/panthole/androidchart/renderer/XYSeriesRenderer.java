...
import com.panthole.androidchart.chart.PointStyle;
import com.panthole.androidchart.renderer.XYSeriesRenderer.FillOutsideLine.Type;
...
public class XYSeriesRenderer extends SimpleSeriesRenderer {
   ...
   * 对mBarLength进行赋值
   * 
   * @param mBarLength mBarLength
   */
  public void setmBarLength(float mBarLength) {
