 ...
 */
package com.panthole.androidchart.model;
...
public class RangeCategorySeries extends CategorySeries {
	...
	private List<Double> moffsetValues = new ArrayList<Double>();
	...
	public synchronized void add(double minValue, double maxValue, double offset) {
		super.add(minValue);
		mMaxValues.add(maxValue);
		moffsetValues.add(offset);
	}
	...
	public double getOffsetValue(int index) {
		return moffsetValues.get(index);
	}
